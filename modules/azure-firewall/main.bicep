...
Basic: a Basic firewall runs a separate management plane and is rejected without it. Ignored by the
Standard and Premium tiers, which have no management IP configuration.''')
